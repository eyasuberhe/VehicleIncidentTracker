>## NOTE: This repo is a fork of Steve Smith's [Clean Architecture](https://github.com/ardalis/VehicleIncidentTracker) repo with additional code to facilitate publication as a [Visual Studio extension](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker). 
> [More info](https://github.com/GregTrevellick/VehicleIncidentTracker#the-fork)
 

<!--BadgesSTART-->
<!-- Powered by https://github.com/GregTrevellick/ReadMeSynchronizer -->
[![Read Me Synchronizer](https://img.shields.io/badge/-powered%20by%20ReadMeSynchronizer-brightgreen.svg)](https://github.com/GregTrevellick/ReadMeSynchronizer)
[![BetterCodeHub compliance](https://bettercodehub.com/edge/badge/GregTrevellick/VehicleIncidentTracker?branch=master)](https://bettercodehub.com/results/GregTrevellick/VehicleIncidentTracker)
[![Codacy Badge](https://api.codacy.com/project/badge/Grade/3b74ee0e8da64daf94199f8a7f2fcf12)](https://www.codacy.com/project/gtrevellick/VehicleIncidentTracker/dashboard?utm_source=github.com&amp;utm_medium=referral&amp;utm_content=GregTrevellick/VehicleIncidentTracker&amp;utm_campaign=Badge_Grade_Dashboard)
 [![CodeFactor](https://www.codefactor.io/repository/github/GregTrevellick/VehicleIncidentTracker/badge)](https://www.codefactor.io/repository/github/GregTrevellick/VehicleIncidentTracker)
...
[![LGTM Alerts](https://img.shields.io/lgtm/alerts/g/ardalis/VehicleIncidentTracker.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/VehicleIncidentTracker/alerts/)
[![Language grade: JavaScript](https://img.shields.io/lgtm/grade/javascript/g/ardalis/VehicleIncidentTracker.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/ardalis/VehicleIncidentTracker/context:javascript)
[![GitHub top language](https://img.shields.io/github/languages/top/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker)
[![Github language count](https://img.shields.io/github/languages/count/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker)
 [![GitHub issues](https://img.shields.io/github/issues-raw/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker/issues)
[![GitHub pull requests](https://img.shields.io/github/issues-pr-raw/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker/pulls)
[![GitHub followers](https://img.shields.io/github/followers/GregTrevellick.svg)](https://github.com/GregTrevellick?tab=followers)
[![GitHub stars](https://img.shields.io/github/stars/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker)
[![GitHub watchers](https://img.shields.io/github/watchers/GregTrevellick/VehicleIncidentTracker.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker/watchers)
[![Sonar&metric=alert_status](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=alert_status)](https://sonarcloud.io/dashboard?id=VehicleIncidentTracker)
[![Sonar&metric=bugs](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=bugs)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=bugs)
[![Sonar&metric=code_smells](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=code_smells)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=code_smells)
[![Sonar&metric=coverage](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=coverage)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=Coverage)
[![Sonar&metric=duplicated_lines_density](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=duplicated_lines_density)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=duplicated_lines)
[![Sonar&metric=ncloc](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=ncloc)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=ncloc)
[![Sonar&metric=reliability_rating](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=reliability_rating)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=reliability_rating)
[![Sonar&metric=security_rating](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=security_rating)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=security_rating)
[![Sonar&metric=sqale_index](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=sqale_index)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=sqale_index)
[![Sonar&metric=sqale_rating](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=sqale_rating)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=sqale_rating)
[![Sonar&metric=vulnerabilities](https://sonarcloud.io/api/project_badges/measure?project=VehicleIncidentTracker&metric=vulnerabilities)](https://sonarcloud.io/component_measures?id=VehicleIncidentTracker&metric=vulnerabilities)
[![Appveyor Build status](https://ci.appveyor.com/api/projects/status/6raa1n0tucf66h0q?svg=true)](https://ci.appveyor.com/project/GregTrevellick/VehicleIncidentTracker)
[![Appveyor unit tests](https://img.shields.io/appveyor/tests/GregTrevellick/VehicleIncidentTracker.svg)](https://ci.appveyor.com/project/GregTrevellick/VehicleIncidentTracker/build/tests)
[![Azure Build Status](https://gregtrevellick.visualstudio.com/VehicleIncidentTracker/_apis/build/status/VehicleIncidentTracker)](https://gregtrevellick.visualstudio.com/VehicleIncidentTracker/_build/latest?definitionId=41)
...
[![Subscribe](https://img.shields.io/badge/subscribe%20to%20receive%20notificatons-grey.svg)](https://github.com/GregTrevellick/VehicleIncidentTracker/subscription)
[![](https://codescene.io/projects/7067/status.svg)](https://codescene.io/projects/7067/jobs/latest-successful/results)

[![Visual Studio Marketplace version](https://img.shields.io/badge/-VehicleIncidentTracker-%23e2165e.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker)
[![Visual Studio Marketplace downloads](https://vsmarketplacebadge.apphb.com/installs/GregTrevellick.VehicleIncidentTracker.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker)
[![Visual Studio Marketplace ratings](https://vsmarketplacebadge.apphb.com/rating/GregTrevellick.VehicleIncidentTracker.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker)
[![Visual Studio Marketplace version](https://vsmarketplacebadge.apphb.com/version/GregTrevellick.VehicleIncidentTracker.svg)](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker)
...
## *Now available as a [project template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker) within Visual Studio.*

## Versions

The master branch is now using .NET Core Version 3.1. If you need a 2.x version use one of these tagged commits:

- [2.2](https://github.com/ardalis/VehicleIncidentTracker/tree/dotnet-core-2.2)
- [2.0](https://github.com/ardalis/VehicleIncidentTracker/tree/dotnet-core-2.0)
...
- [Install the Visual Studio Template](https://marketplace.visualstudio.com/items?itemName=GregTrevellick.VehicleIncidentTracker) and use it within Visual Studio
...
[Steve 'ardalis' Smith](https://github.com/ardalis/VehicleIncidentTracker)
